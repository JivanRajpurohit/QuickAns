		...
		<div class="main-content-area ptb-100">
			...
			<%
					...
					<%
						...
						CachedRowSet rscc = DBConnection.selectquery("select *from answer a JOIN expertuser e ON a.exp_id=e.exp_id and a.q_id='"+d+"'");
									...
									<div class="d-flex">
										...
										<div class="flex-grow-1 ms-3">
											...
											else
											{
											 ...
											 %>
												<a href="expertpostanswer.jsp?x=<%= rst.getString(1) %>" class="default-btn">Answer</a>
