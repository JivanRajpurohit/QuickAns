				...
				<div class="row">
					<div class="col-lg-6">
						<div class="contact-form">
							...
							<form  action="AddContactExpert" method="post">
								<div class="row">
									<div class="col-lg-12">
									...
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input type="text" name="t3" id="phone_number" required data-error="Please enter your number" class="form-control" placeholder="Enter Phone Number">
											<div class="help-block with-errors"></div>
										</div>
									</div>
					...
					<div class="col-lg-6">
						<div class="contacts-info">
							...
							<ul class="address">
								...
								<li>
									<span>Email:</span>
									<a href="expertcontact.jsp"><span class="__cf_email__" data-cfemail="b3c3dad5caf3d4ded2dadf9dd0dcde">quickansnks@gmail.com</span></a>
								</li>
								<li class="location">
									<span>Address:</span>
