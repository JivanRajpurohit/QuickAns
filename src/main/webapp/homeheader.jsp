					...
					<nav class="navbar navbar-expand-md navbar-light">
						...
						<div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
							<ul class="navbar-nav m-auto">
								...
								<li class="nav-item">
									<a href="userlogin.jsp" class="nav-link">
										Ask
									</a>
								</li>
								
								<li class="nav-item">
									<a href="expertsdetailsforvisitor.jsp" class="nav-link">
										Experts
									</a>
								</li>
								
								<li class="nav-item">
									<a href="homeaboutus.jsp" class="nav-link">
										About Us
									</a>
								</li>
								...
								<li class="nav-item">
									<a href="homecontactus.jsp" class="nav-link">Contact Us</a>
								</li>
							...
							<div class="others-options">
								<ul>
									<li>
										<form class="search-box" action="home.jsp">
