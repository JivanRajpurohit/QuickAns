...
<!-- Start Page title Area -->
		...
		<div class="sign-up-area ptb-100">
			<div class="container">
				...
				<form class="user-form" action="ResetPasswordExp" method="post"> 
					<div class="row">
						
						<input class="form-control" type="text" name="expemail" value=<%= session.getAttribute("expemail") %>>
						...
						<div class="col-12">
                           ...
                           {
                        	   out.print("<font color='red'>New Password & Old Password Doesn't Match</font>");
