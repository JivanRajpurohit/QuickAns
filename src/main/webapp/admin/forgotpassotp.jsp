						...
						<div class="card">
							<div class="card-body">
								<div class="m-sm-4">
									...
									<form action="../ForgotPassCheckOTP" method="post" class="bounce">
              
									
									<input class="form-control form-control-lg" type="hidden" name="sotp" value=<%=session.getAttribute("sotp") %>>
										<div class="mb-3">
											<label class="form-label">OTP</label>
											<input class="form-control form-control-lg" type="text" name="t1" placeholder="Enter your OTP" />
